...
4. Crie/Referencie uma nova **branch** e nomeie como `feat/community/HalineNogueira`:'git checkout -b feat/community/Haline'
    > Exemplo: 'git checkout -b feat/community/halineNogueira'
...
7. Adicione suas alterações a "staging area" com o comando `git add community/HalineNogueira.md`;
8. Crie um commit e adicione a mensagem indicando a adição do seu perfil `git commit -m"feat: add HalineNogueira profile"`;
9. Envie as alterações para o seu repositório remoto `git push origin feat/community/HalineNogueira`; 
...
4. Create/Reference a new **branch** and name it `feat/community/YOUR_USERNAME`: `git checkout -b feat/community/YOUR_USERNAME`;
    > Example: `git checkout -b feat/community/HalineNogueira`
